...
class BaseInfluencer(ABC):
    ...
    def __init__(self, username: str, followers: int, engagement_rate: float):
        ...
        self.campaigns_participated: list[str] = []
    ...
    def display_campaigns_participated(self, campaigns_list) -> str:
        ...
        for campaign_id in self.campaigns_participated:
            campaign = next((c for c in campaigns_list if c.campaign_id == campaign_id), None)
            if campaign:
